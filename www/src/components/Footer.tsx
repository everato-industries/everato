    ...
    <footer className="bg-gray-100 border-t">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">Everato</h3>
            <p className="text-gray-600 text-sm">
              Your modern event management platform. Find events, manage tickets, and connect with others.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/events" className="text-gray-600 hover:text-blue-600 text-sm">Browse Events</Link></li>
              <li><Link to="/categories" className="text-gray-600 hover:text-blue-600 text-sm">Categories</Link></li>
              <li><Link to="/organizers" className="text-gray-600 hover:text-blue-600 text-sm">Event Organizers</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Everato. All rights reserved.
          </p>
